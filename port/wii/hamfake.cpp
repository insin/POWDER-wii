...
#define HAM_SCRH	(TILEHEIGHT*HAM_SCRH_T)
...
rebuildVideoSystemFromGlobals()
{
    ...
    glbVideoSurface = SDL_SetVideoMode(640, 480, 24, SDL_DOUBLEBUF);
	...
	// SDL Wii seems to have issues using the Wiimote as a combined mouse/pad
...
hamfake_endWritingSession()
{
    ...
    fp = hamfake_fopen("sd:/apps/powder/powder.sav", "wb");
...
hamfake_isPressed(BUTTONS button)
{
    ...
    {
	case BUTTON_UP:
	return ((SDL_JoystickGetHat(joystick, 0) & SDL_HAT_UP) != 0);

	case BUTTON_DOWN:
	return ((SDL_JoystickGetHat(joystick, 0) & SDL_HAT_DOWN) != 0);

	case BUTTON_LEFT:
	return ((SDL_JoystickGetHat(joystick, 0) & SDL_HAT_LEFT) != 0);

	case BUTTON_RIGHT:
	return ((SDL_JoystickGetHat(joystick, 0) & SDL_HAT_RIGHT) != 0);

    case BUTTON_A:
	return (SDL_JoystickGetButton(joystick, REMOTE_2) ||
            SDL_JoystickGetButton(joystick, CLASSIC_A));

    case BUTTON_B:
	return (SDL_JoystickGetButton(joystick, REMOTE_1) ||
            SDL_JoystickGetButton(joystick, CLASSIC_B));

    case BUTTON_R:
	return (SDL_JoystickGetButton(joystick, REMOTE_A) ||
            SDL_JoystickGetButton(joystick, CLASSIC_R) ||
            SDL_JoystickGetButton(joystick, CLASSIC_ZR));

    case BUTTON_L:
	return (SDL_JoystickGetButton(joystick, REMOTE_B) ||
            SDL_JoystickGetButton(joystick, CLASSIC_L) ||
            SDL_JoystickGetButton(joystick, CLASSIC_ZL));

    case BUTTON_X:
	return (SDL_JoystickGetButton(joystick, CLASSIC_X));

    case BUTTON_Y:
	return (SDL_JoystickGetButton(joystick, CLASSIC_Y));

    case BUTTON_START:
	return (SDL_JoystickGetButton(joystick, REMOTE_PLUS) ||
            SDL_JoystickGetButton(joystick, CLASSIC_PLUS));

    case BUTTON_SELECT:
	return (SDL_JoystickGetButton(joystick, REMOTE_MINUS) ||
            SDL_JoystickGetButton(joystick, CLASSIC_MINUS));
    };
...
ham_Init()
{
    ...
    fp = hamfake_fopen("sd:/apps/powder/powder.sav", "rb");
    if (fp)
    {
